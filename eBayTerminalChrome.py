...
# eBayTerminalChrome.py - This python program is run through
...
# /Users/user/Documents/Web_Scraping/eBayTerminalChrome.py
...
print('Chrome options are working: ')
...
# Chrome is opened remotely using selenium.
chromedriver = "/Users/user/WebDriver_ExeFiles/chromedriver"
os.environ["webdriver.chrome.driver"] = chromedriver
driver = webdriver.Chrome(chromedriver)
print(type(driver))
driver.get('https://www.ebay.com')
print('Chrome has navigated to eBay successfully')
...
try:
    ...
    newElem = driver.find_element_by_xpath(
        "//input[@type='checkbox'][@aria-label='New']"
    )
    newElem.click()
...
print(
    "The number of items that are new and buy it not=w items is: " + availMatch
)
...
# Put the collected information into a CSV file.
# May eventually need to use itercontent().
